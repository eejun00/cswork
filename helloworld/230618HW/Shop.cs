...
namespace _230618HW
{
    public class Shop
    {
        ...
        public void InStore(ref List<Shopitem> inventory, ref int gold)
        {
        ...
        public void PrintShop(List<Shopitem> shop)
        {
        ...
        public void Printinven(List<Shopitem> inventory)
        {
            Console.WriteLine("\n-------------------------가방-------------------------");
        ...
        public void ShuffleShop(List<Shopitem> shop, List<Shopitem> shop2)
        {
            Random random = new Random();
            int tempNum;
            Console.WriteLine();
